    ...
    render() {
        ...
        return (
            <tr className="text-center body-list">
                ...
                <td className="pt-5">
                    <img src={logo} className="mr-3" style={{ width: "30px" }} alt={name} />
                    <Link to={{
                        pathname: `/details/${id}`,
                ...
                <td className="pt-5">{symbol}</td>
                <td className="pt-5">$ {price}</td>
                <td>
                    <span className={(percent_change_24h < 0) ? "badge badge-pill badge-danger p-3" : "badge badge-pill badge-success p-3"}>
